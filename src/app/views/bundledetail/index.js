                        ...
                        <Grid container spacing={4}>
                            ...
                            <Grid item xs={12} md={6}>
                                <Box sx={{ color: "white" }}>
                                    ...
                                    >
                                        <Box sx={{ fontWeight: 'bold', fontSize: '2rem' }}>
                                            Bundle Items
                                        </Box>
                                        ...
                                        <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                            ...
                                            <Typography
                                                ...
                                                sx={{ fontSize: { xs: "1rem", md: "1rem" } }}
                                            >
                                                Sub Total : $ <span style={{ textDecoration: "line-through" }} > {detail?.products?.reduce((acc, item) => acc + Number(item.price), 0)}</span>
                                            </Typography>
                                        </Box>
                                        <Typography
                                            variant="h4"
                                            sx={{ fontWeight: "bold", mt: 2, fontSize: { xs: "2rem", md: "2rem" }, textAlign: 'right' }}
                                        >
                                            Total: $ {detail?.price}
                                        </Typography>
                                    </Box>
