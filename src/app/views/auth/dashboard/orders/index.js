  ...
  return (
    <Box>
      ...
      <Dialog open={open1} onClose={handleClose}>
        <DialogTitle sx={{ color: "black", overflowX: "hidden" }}>
          {"Order Details"}
        </DialogTitle>
        <FormControl>
          <FormLabel
        ...
        {selectedData?.length > 0 ? (
          ...
          <Box sx={{ color: "black", fontWeight: "bold", margin: "0 auto" }}>
            No Items in Cart
          </Box>
        )}
        <DialogActions>
            ...
            {products?.map((item, index) => (
              ...
              >
                ...
                <TableCell
                  sx={{ color: "black !important", textAlign: "center" }}
                >
                  {item?.paymentType == "cashOnDelivery" ? "COD" : "Card"}
                </TableCell>
                <TableCell
                  sx={{ color: "black !important", textAlign: "center",textTransform:"capitalize" }}
                >
                  {item?.status}
                </TableCell>
                <TableCell
                ...
                >
                  <Button
                    ...
                    onClick={() => {
                      setOpen1(true);
                      setModalValue(item?.price);
                      setTableId(item?.id);
                      setSelectedData(item?.details);
