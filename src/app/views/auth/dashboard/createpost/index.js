      ...
      <Box component={'form'} onSubmit={handleSubmit(addProduct)} sx={{ width: "80%", margin: '0 auto', mt: 10 }}>
        ...
        <Grid container>
          <Grid item xs={6}>
            ...
            <TextField  sx={{color:'black'}}  {...register('productName', { required: true })} error={!!errors.productName}
              helperText={errors.productName ? "Product name is required" : ""} size='small' id="outlined-basic" label="Product Name" variant="outlined" />
          </Grid>

          <Grid item xs={6}>

            <TextField sx={{color:'black'}}  {...register('productPrice', { required: true })} error={!!errors.productPrice} type='number'
