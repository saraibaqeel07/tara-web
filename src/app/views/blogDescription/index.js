...
const BlogDetail = () => {
    ...
    return (
        ...
        >
            ...
            <Grid
                item
                md={12} // Adjust the width on larger screens
                sm={12} // For smaller screens, make it take up most of the space
                xs={12} // For extra small screens, also take most of the space
                sx={{
                    display: "flex",
